...
**Команда:** Субботина Олеся, Анисимова Карина, Багрянова Катя<br/>
...
Критическим минусом первого подхода стало отсуствие его поддержки в стандартной Java. Напротив, минусы второго подхода было возможно покрыть усилиями разработчиков и аккуратным использованием стандартной библиотеки Java. Поэтому мы решили остановиться именно на нем.
